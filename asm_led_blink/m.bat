...
"C:\Program Files (x86)\Microchip\MPLABX\v5.30\mpasmx\mpasmx.exe" -w0 -q -p12lf1571 -l"build_rls/main.lst" -e"build_rls/main.err" -o"build_rls/main.o" "src/main.asm" 
"C:\Program Files (x86)\Microchip\MPLABX\v5.30\mpasmx\mplink.exe" -p12lf1571 -w -m"build_rls/SW0037-02v01pre.map" -z__MPLAB_BUILD_RLS=1  -o"build_rls/SW0037-02v01pre.cof" build_rls/main.o
